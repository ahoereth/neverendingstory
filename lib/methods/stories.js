...
Meteor.methods({
  ...
  'stories/watchNextElection': function() {
    ...
    nextElectionTimeout = Meteor.setTimeout(function() {
      ...
      // Change of activity should depend on the change of activity
      // in the last couple of elections in comparision to the current
      // election. See #1
      var oldCountdown = story.countdown || Stories.COUNTDOWN.init;
      var countdown = oldCountdown - 1000;
