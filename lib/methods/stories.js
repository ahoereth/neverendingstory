...
Meteor.methods({
  ...
  'stories/new': function(args) {
    ...
    var _id = Stories.insert({
      ...
      countdown: 5000//259200000 // We start with a countdown of 3 days
    });
  ...
  'stories/watchNextElection': function() {
    ...
    // Start new timeout.
    nextElectionTimeout = setTimeout(function() {
      // // TODO: The best component should be elected in here. @WhiteFangs
      // var paragraphs = Components.findOne({story : story}, {sort: {priority : 1, voteCount : 1}});
